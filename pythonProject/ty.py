...
# root.geometry("600x260")
# image = Image.open('1_OaMB1fyHzDVK4FR7ogiCIA.jpeg')
...
# print(rt2)
button3= tk.Button(root,text="Start",command=lambda:Excel.on_open(filename1,filename),height=1,width=10).place(x=250,y=180)
