...
with open(r"C:\Users\Jayendra\Desktop\Just_Dial\Scrap.html", "w", encoding='utf-8') as file1:
...
def getdata(url,c):
    if c==1:
        r1=""
        r1=s.get(url + "search", params=payload, headers=headers)
...
#     r.html.render(sleep=1)
    ...
    with open(r"C:\Users\Jayendra\Desktop\Just_Dial\Scrap1.html", "w", encoding='utf-8') as file2:
...
def scraping(soup2):
    ...
    for i in soup2.find_all("a", {"class": "a-link-normal a-text-normal"}):
        ...
        l1.append(l2)
        print(l1)
        with open("C:\\Users\\Administrator\\Desktop\\Pyt\\" + str(filename) + ".html", "w", encoding='utf-8') as file3:
...
while True:
    ...
    with open(r"C:\Users\Administrator\Desktop\Pyt\Scrap" + str(counter) + ".html", "w", encoding='utf-8') as file1:
...
conn = sqlite3.connect(r"C:\Users\Administrator\Desktop\Pyt\example.db")
c = conn.cursor()
